...
public class OtherUserProfileActivity extends AppCompatActivity {
    ...
    private Button sendRequest,sendMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendRequest=(Button)findViewById(R.id.send_friend_request_other);
        ...
        profile_pic_other_user=(ImageView) findViewById(R.id.profile_pic_other_user);
        profile_pic_other_user.setImageResource(R.drawable.profile_pic);
 ...
 //       linearLayout.setBackgroundColor(getResources().getColor(R.color.bottom_layout_select_tab));
        ...
        try {
            Glide.with(this).load(R.drawable.profile_pic1).into((ImageView) findViewById(R.id.backdrop));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    //listener for bottom activity
